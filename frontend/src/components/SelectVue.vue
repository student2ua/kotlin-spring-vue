    ...
    <div v-else>
        <b-container fluid>
            <b-row class="my-1">
                ...
                <b-col sm="10">
                    <b-form-select id="selected-Sbj" v-model="selectedSbj" :options="subjects" value-field="first" text-field="second" @change="handleChangeSbj">
            ...
            <b-row class="my-1">
                ...
                <b-col sm="10">
                    <div class="mt-2"></div>
                    <b-form-select id="selected-LT" v-model="selectedLT" :options="lessonType" value-field="first" text-field="second" @change="handleChangeLT">
                        <template v-slot:first>
                            <option :value="null" disabled selected>-- Выберите один из вариантов --</option>
                        </template>
                    </b-form-select>
                </b-col>
            </b-row>
            <b-row class="my-1">
                ...
                <b-col sm="10">
                    <div class="mt-2"></div>
                    <b-form-select id="selected-PSG" v-model="selectedPSG" :options="psgs" value-field="first" text-field="second" @change="handleChangePSG">
                        <template v-slot:first>
                            <option :value="null" disabled selected>-- Выберите один из вариантов --</option>
                        </template>
                    </b-form-select>
  ...
  created() {
   ...
   methods: {
      ...
      handleChangeLT: function (e) {
          ...
          let self = this;
          this.psgs=[];
          AXIOS.get(`${BASE_URL}/subjects/${self.selectedSbj}/lessontypes/${e}/psgs`, { headers: { Authorization: "Bearer " + this.$store.getters.getToken }  })
              .then(function(response) {
                  console.log(
      ...
      handleChangePSG: function (e) {
          ...
          AXIOS.get(`${BASE_URL}/subjects/${self.selectedSbj}/lessontypes/${self.selectedPSG}/psgs/${e}/handsontable`, { headers: { Authorization: "Bearer " + this.$store.getters.getToken }  })
              .then(function(response) {
                  console.log(
